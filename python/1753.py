...
def dijkstra(var_start):
    ...
    while heap:                                                                                 # [[0, 1]]
        ...
        for now_v, vtx_w in mat_table[vtx_v]:  #해당 vtx_v이 갈 수 있는 vertex들의 정보 꺼내옴      # [[3, 3], [7, 4]]
...
list_shortest_dist = [INF] * (var_V + 1) # [1000000000.0, 1000000000.0, 1000000000.0, 1000000000.0, 1000000000.0, 1000000000.0]
heap = []
